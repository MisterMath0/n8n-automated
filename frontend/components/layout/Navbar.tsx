            ...
            <div className="flex items-center justify-between">
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium shadow-lg hover:shadow-blue-500/25 transition-all duration-300"
                >
                  Get Started
                </motion.button>
              </motion.div>
              ...
              <div className="glass-dark rounded-2xl p-6 shadow-2xl">
                <div className="flex flex-col gap-4">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="mt-4 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium shadow-lg"
                  >
                    Get Started
                  </motion.button>
                </div>
